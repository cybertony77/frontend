      ...
      background: 'linear-gradient(380deg, #1FA8DC 0%, #FEB954 100%)'
        ...
        <div className="login-container">
          <div className="logo-section">
            <Image src="/logo.png" alt="Logo" width={100} height={100} className="logo-icon" priority />
        ...
        <form onSubmit={handleLogin} autoComplete="off">
            ...
            <div className="form-group" style={{ marginBottom: passwordError ? 4 : 24 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', marginTop: 8 }}>
                <a
                  ...
                  onClick={e => { 
                    e.preventDefault(); 
                    setForgotMsg('Contact Mr. George Magdy (admin) or Tony Joseph (developer)'); 
                  }}
                >
          ...
          <div className="footer-text">
            <p>Mr. George Magdy Attendance System</p>
            <p>Copyright &copy; {new Date().getFullYear()} - Mr. George Magdy</p>
          </div>
        </div>
    </div>
  );
