...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Handle homework status values - store string directly in hwDone field
    let hwDoneValue;
    if (hwStatus === null || hwStatus === undefined) {
    ...
    const result = await db.collection('students').updateOne(
      { id: student_id },
      { $set: { [`weeks.${weekIndex}.hwDone`]: hwDoneValue } }
    );
